...
(function (window) {
    ...
    if (top.__qunit_runner) {
        ...
        QUnit.done = function (obj) {
            runner.pageProgress(window.frameElement, obj.failed, obj.total, "done", true);
        };
        QUnit.testStart = function (obj) {
            runner.pageProgress(window.frameElement, 0, 0, obj.name + " started");
        };
        QUnit.testDone = function (obj) {
            runner.pageProgress(window.frameElement, obj.failed, obj.total, obj.name);
        };
    }
})(this);